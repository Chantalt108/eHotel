...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (reqURI.contains("addRoom") && (ses == null || (ses != null && ses.getAttribute("User") == null))) {
             String loginURL = req.getContextPath() + "/faces/login.xhtml";
            res.sendRedirect(loginURL);
        } else if(reqURI.contains("addRoom") && (ses == null || (ses != null && ses.getAttribute("User") != null))){
        ...
        } else if (reqURI.contains("updateRoom") && (ses == null || (ses != null && ses.getAttribute("User") == null))) {
             String loginURL = req.getContextPath() + "/faces/login.xhtml";
            res.sendRedirect(loginURL);
        } else if(reqURI.contains("updateRoom") && (ses == null || (ses != null && ses.getAttribute("User") != null))){
             UserAccount user =(UserAccount) ses.getAttribute("User");
        ...
        } else if (reqURI.contains("viewBookings") && (ses == null || (ses != null && ses.getAttribute("User") == null))) {
            String loginURL = req.getContextPath() + "/faces/login.xhtml";
            res.sendRedirect(loginURL);
        } else if (reqURI.contains("viewBookings") && (ses == null || (ses != null && ses.getAttribute("User") != null))) {
            UserAccount user =(UserAccount) ses.getAttribute("User");
        ...
        } else if (reqURI.contains("employeeViewBookings") && (ses == null || (ses != null && ses.getAttribute("User") == null))) {
             String loginURL = req.getContextPath() + "/faces/login.xhtml";
            res.sendRedirect(loginURL);
        } else if(reqURI.contains("employeeViewBookings") && (ses == null || (ses != null && ses.getAttribute("User") != null))){
             UserAccount user =(UserAccount) ses.getAttribute("User");
